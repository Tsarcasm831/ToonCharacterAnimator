...
export const ITEM_DATA: Record<string, ItemData> = {
  ...
  'Shovel': { name: 'Shovel', description: 'Useful for digging up disturbed ground.', type: 'weapon', rarity: 'common', stats: { damage: 4 } },
  ...
  'Porkchop': { name: 'Porkchop', description: 'Fresh pig meat. Useful for cooking and survival.', type: 'material', rarity: 'common' },
  'Bone Fragments': { name: 'Bone Fragments', description: 'Broken bone shards salvaged from a carcass.', type: 'material', rarity: 'common' },
  'Leather': { name: 'Leather', description: 'Cured hide used for crafting and armor.', type: 'material', rarity: 'common' },
  ...
  'Stick': { name: 'Stick', description: 'A small branch useful for crafting or kindling.', type: 'material', rarity: 'common' },
  'Stone': { name: 'Stone', description: 'A small loose rock useful for crafting.', type: 'material', rarity: 'common' },
  ...
  'Grass': { name: 'Grass', description: 'Dry grass strands. Bundle enough together to twist into rope.', type: 'material', rarity: 'common' },
  'Rope': { name: 'Rope', description: 'Twisted grass rope. Useful for binding and crafting.', type: 'material', rarity: 'common' },
  'Leather Shirt': { name: 'Leather Shirt', description: 'A simple shirt stitched from cured hide.', type: 'armor', rarity: 'common', stats: { defense: 6 } },
  'Leather Pants': { name: 'Leather Pants', description: 'Tough trousers cut from cured leather.', type: 'armor', rarity: 'common', stats: { defense: 5 } },
  'Wooden Sword': { name: 'Wooden Sword', description: 'A training sword carved from hardwood.', type: 'weapon', rarity: 'common', stats: { damage: 8 } },
  'Wooden Shoes': { name: 'Wooden Shoes', description: 'Rough shoes lashed together from wood and rope.', type: 'armor', rarity: 'common', stats: { defense: 2 } }
};
...
export const ITEM_IMAGES: Record<string, string> = {
  ...
  'Porkchop': '/assets/images/items/new/porkchop.png',
  'Bone Fragments': '/assets/images/items/new/bone_fragments.png',
  'Leather': '/assets/images/items/new/raw_leather.png',
  ...
  'Wooden Shoes': '/assets/images/items/new/wooden_shoes.png'
};
...
export interface CraftingRecipe {
  ...
  category: 'armor' | 'weapons' | 'materials';
}
...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  {
    result: 'Rope',
    resultCount: 1,
    ingredients: [{ name: 'Grass', count: 5 }],
    category: 'materials',
  },
  {
    result: 'Leather Shirt',
    resultCount: 1,
    ingredients: [{ name: 'Leather', count: 10 }],
    category: 'armor',
  },
  {
    result: 'Leather Pants',
    resultCount: 1,
    ingredients: [{ name: 'Leather', count: 8 }],
    category: 'armor',
  },
  {
    result: 'Wooden Sword',
  ...
  },
  {
    result: 'Wooden Shoes',
    resultCount: 1,
    ingredients: [{ name: 'Rope', count: 2 }, { name: 'Wood', count: 2 }],
    category: 'weapons',
  },
];
