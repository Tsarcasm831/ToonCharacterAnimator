...
export const OUTFIT_PRESETS: Record<OutfitType, Partial<PlayerConfig>> = {
  ...
  peasant: {
    outfit: 'peasant',
    equipment: { helm: false, shoulders: false, shield: false, shirt: true, pants: true, shoes: true, mask: false, hood: false, quiltedArmor: false, leatherArmor: false, heavyLeatherArmor: false, ringMail: false, plateMail: false, robe: false, blacksmithApron: false, mageHat: false, bracers: false, cape: false, belt: true },
    shirtColor: '#8d6e63',
    pantsColor: '#5d4037'
  },
  warrior: {
    outfit: 'warrior',
    equipment: { helm: true, shoulders: true, shield: true, shirt: true, pants: true, shoes: true, mask: true, hood: true, quiltedArmor: false, leatherArmor: false, heavyLeatherArmor: false, ringMail: false, plateMail: false, robe: false, blacksmithApron: false, mageHat: false, bracers: true, cape: false, belt: true },
    shirtColor: '#607d8b',
    pantsColor: '#37474f'
  },
  noble: {
    outfit: 'noble',
    equipment: { helm: false, shoulders: false, shield: false, shirt: true, pants: true, shoes: true, mask: false, hood: false, quiltedArmor: false, leatherArmor: false, heavyLeatherArmor: false, ringMail: false, plateMail: false, robe: true, blacksmithApron: false, mageHat: false, bracers: false, cape: true, belt: true },
    shirtColor: '#3f51b5',
    pantsColor: '#1a237e'
  }
};
