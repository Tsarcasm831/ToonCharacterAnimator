...
export const Header: React.FC<HeaderProps> = ({ biome, onToggleWorldMap, onToggleBestiary }) => (
    <div className="absolute top-0 left-0 w-full p-6 z-10 pointer-events-none flex flex-col md:flex-row items-start justify-between">
