...
export const Navigation: React.FC<NavigationProps> = ({ activePage, onPageChange }) => {
    ...
    return (
        <nav className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-2 px-4 py-3 bg-black/60 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
            {navItems.map((item) => {
