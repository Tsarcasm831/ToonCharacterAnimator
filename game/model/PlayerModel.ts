...
export class PlayerModel {
    ...
    private readonly waterClipPlane = new THREE.Plane(new THREE.Vector3(0, -1, 0), 0);
    ...
    setWaterline(surfaceY: number | null) {
        const clippingPlanes = surfaceY === null
            ? null
            : [this.waterClipPlane.set(new THREE.Vector3(0, -1, 0), surfaceY)];
