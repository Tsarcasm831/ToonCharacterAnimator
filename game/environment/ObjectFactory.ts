...
import { DisturbedGroundFactory } from './objects/DisturbedGroundFactory';
...
export class ObjectFactory {
    ...
    static createDisturbedGround(position: THREE.Vector3, cellSize: number = 1.0) {
        return DisturbedGroundFactory.createDisturbedGround(position, cellSize);
    }
    ...
    static createPickupRock(position: THREE.Vector3) {
        return ScatterFactory.createPickupRock(position);
    }

    static createPickupStick(position: THREE.Vector3) {
        return ScatterFactory.createPickupStick(position);
    }
